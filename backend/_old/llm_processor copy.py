...
def load_processed_articles(
    model, file_path_template="api_data/processed_articles_{model}.json"
):
...
def save_processed_articles(
    articles, model, file_path_template="api_data/processed_articles_{model}.json"
):
...
def process_article_openrouter(article, model, system_instruction):
    with open("data/API_KEY_OPENROUTER", "r") as f:
        api_key = f.readline().strip()
